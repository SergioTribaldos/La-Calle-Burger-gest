...
public class PanelAltaRestaurante extends JPanel {
	...
	public PanelAltaRestaurante(Ventana ventana) {
		...
		botonAltaRestaurante.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (pulsado[0] == false) {
					...
					try {
						Restaurante nuevo = new Restaurante(campoCif.getText(), campoDireccion.getText(),
								campoTelefono.getText(), campoCodigoRestaurante.getText(), ventana.getConexion());
						...
						JOptionPane.showMessageDialog(ventana, "El restaurante ha sido dado de alta");
		...
		//Quita el mensaje de error cuando mueves el raton con un delay de 1 segundo
